        ...
        <table class="w-full mb-6">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100">
                    ...
                    <td class="py-2">
                        <input type="text" wire:model="productName" placeholder="Nama produk"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                    </td>
                    <td class="py-2">
                        <input type="number" wire:model="costPrice" placeholder="Modal"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                    </td>
                    <td class="py-2">
                        <input type="number" wire:model="sellPrice" placeholder="Harga"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                    </td>
                    <td class="py-2 font-medium">Rp {{ number_format($this->calculateRowTotal()) }}</td>
                    <td class="py-2">
                        <button wire:click="addItem" class="p-2 text-white bg-green-500 rounded-full hover:bg-green-600">
    ...
    <div class="w-[400px] p-6 bg-gray-50">
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
            <div>
                ...
                <input type="text" wire:model="carType" placeholder="Masukan Jenis Mobil"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700">Plat Nomor</label>
                <input type="text" wire:model="carId" placeholder="Masukan Nomor Plat"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700">Nama Pembeli</label>
                <input type="text" wire:model="customerName" placeholder="Masukkan nama pembeli"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700">Nomor WhatsApp</label>
                <input type="tel" wire:model="customerPhone" placeholder="Masukkan nomor WhatsApp"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
            </div>
            ...
            <button wire:click="printNota" class="w-full py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
